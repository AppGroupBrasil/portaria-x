...
export const DARK: ThemePalette = {
  ...
  isDarkBase: true,
  swatch: "#13315c",
  pageBg: "linear-gradient(180deg, #0a1830 0%, #0d2143 55%, #102a54 100%)",
  headerBg: "linear-gradient(135deg, #0f2a55 0%, #163a70 100%)",
  headerBorder: "1px solid rgba(255,255,255,0.09)",
  headerShadow: "0 4px 24px rgba(0,0,0,0.35)",
  btnBg: "rgba(255,255,255,0.07)",
  btnBorder: "1px solid rgba(255,255,255,0.12)",
  btnGrad: "linear-gradient(135deg, #1f6fd4 0%, #1452a6 50%, #0d3170 100%)",
  btnGradHover: "linear-gradient(135deg, #2b7ee4 0%, #1d63bd 50%, #134088 100%)",
  badgeGrad: "linear-gradient(135deg, #1f5fc0 0%, #1648a0 50%, #0f3578 100%)",
  text: "#f5f8fc",
  textSecondary: "#cdd9e6",
  textMuted: "#9fb2c6",
  textAccent: "#fff",
  textHeading: "#f1f5f9",
  textSemi: "#e6edf5",
  textDim: "rgba(233,240,248,0.82)",
  cardBg: "rgba(255,255,255,0.065)",
  cardBorder: "1px solid rgba(255,255,255,0.11)",
  surfaceBg: "rgba(255,255,255,0.045)",
  iconColor: "#fff",
  iconBoxBg: "linear-gradient(135deg, rgba(125,211,252,0.16), rgba(125,211,252,0.04))",
  iconBoxBorder: "1px solid rgba(255,255,255,0.14)",
  featureBg: "rgba(255,255,255,0.06)",
  featureBorder: "2px solid rgba(255,255,255,0.12)",
  featureIconBoxBg: "linear-gradient(135deg, rgba(125,211,252,0.18), rgba(125,211,252,0.05))",
  featureIconBoxBorder: "1px solid rgba(255,255,255,0.13)",
  accent: "#1450a6",
  accentBright: "#7dd3fc",
  accentLight: "rgba(36,99,235,0.18)",
