...
export default function PortariaVirtualTutorial() {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ background: "#f0fdf4", borderRadius: "12px", padding: "16px", border: "2px solid #16a34a" }}>
            ...
            <div style={{ background: "var(--color-card, #fff)", borderRadius: "8px", padding: "14px 16px", border: "1px solid #d1fae5", marginBottom: "8px" }}>
              <p style={{ fontWeight: 700, fontSize: "15px", color: "#374151" }}>
                <ShoppingCart className="w-5 h-5 inline-block mr-1" style={{ verticalAlign: "-2px", color: "#16a34a" }} />
                1 x Mini Smart Switch WiFi
              </p>
              <p style={{ fontSize: "14px", color: "#16a34a", fontWeight: 700, marginTop: "4px" }}>R$20~35</p>
              <div style={{ display: "flex", gap: "12px", marginTop: "6px", flexWrap: "wrap" }}>
                {[
                  ...
                  <a key={link.loja} href={link.url} target="_blank" rel="noopener noreferrer"
                    style={{ fontSize: "12px", color: "#2d3354", textDecoration: "none", padding: "3px 8px", borderRadius: "4px", background: "#eef0f5", display: "flex", alignItems: "center", gap: "3px" }}>
                    {link.loja} <ExternalLink className="w-4 h-4" />
                  </a>
                ))}
              </div>
            </div>
            <div style={{ background: "#ecfdf5", borderRadius: "8px", padding: "8px 12px", textAlign: "center" }}>
              <p style={{ fontWeight: 800, fontSize: "16px", color: "#16a34a" }}>CUSTO: R$22 a R$37 por portao</p>
            </div>
          </div>
          ...
          <div style={{ background: "#f9fafb", borderRadius: "12px", padding: "16px", border: "1px solid #d1d5db" }}>
              ...
              <div key={i} style={{ background: "var(--color-card, #fff)", borderRadius: "8px", padding: "10px", border: "1px solid #e5e7eb", marginBottom: "6px" }}>
                ...
                {item.links.length > 0 && (
                  <div style={{ display: "flex", gap: "6px", marginTop: "6px" }}>
                    {item.links.map((link) => (
                      <a key={link.loja} href={link.url} target="_blank" rel="noopener noreferrer"
                        style={{ fontSize: "12px", color: "#2d3354", textDecoration: "none", padding: "2px 6px", borderRadius: "4px", background: "#eef0f5" }}>
                        {link.loja} ↗
                      </a>
                    ))}
                  </div>
            ...
            <div style={{ background: "#f3f4f6", borderRadius: "8px", padding: "8px 12px", textAlign: "center", marginTop: "4px" }}>
              <p style={{ fontWeight: 800, fontSize: "16px", color: "#6b7280" }}>CUSTO: R$50 a R$75 por portao</p>
            </div>
          </div>
        </div>
      ),
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <div style={{ background: "var(--color-card, #fff)", borderRadius: "12px", padding: "16px", border: "2px solid #0ea5e9" }}>
            <p style={{ fontWeight: 700, color: "var(--card-foreground)", marginBottom: "10px" }}>COMO TESTAR:</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              {[
                ...
                <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "12px" }}>
                  ...
                  <p style={{ fontSize: "15px", color: "#374151", lineHeight: 1.5 }}>{txt}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ background: "#fffbeb", borderRadius: "12px", padding: "16px", border: "1px solid #fde68a" }}>
            <p style={{ fontWeight: 700, fontSize: "16px", color: "#92400e", marginBottom: "8px" }}>NAO PRECISA TER MEDO!</p>
            <p style={{ fontSize: "15px", lineHeight: 1.7, color: "#374151" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              ...
              <div key={i} style={{ background: "var(--color-card, #fff)", borderRadius: "8px", padding: "14px 16px", border: "1px solid #e5e7eb", display: "flex", alignItems: "flex-start", gap: "10px" }}>
                <span style={{
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <div style={{ background: "#faf5ff", borderRadius: "12px", padding: "16px", border: "1px solid #e9d5ff" }}>
            <p style={{ fontWeight: 700, fontSize: "16px", color: "#5b21b6", marginBottom: "8px" }}>CONECTAR ESP32 NO MODULO RELE</p>
            <p style={{ fontSize: "15px", lineHeight: 1.7, color: "#374151" }}>
  ...
  return (
    <div style={{ minHeight: "100dvh", background: "var(--color-card, #fff)", display: "flex", flexDirection: "column" }}>
      {/* Header */}
      <header style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          ...
          <div style={{ flex: 1 }}>
            <h1 style={{ fontSize: "18px", fontWeight: 700, color: p.text, display: "flex", alignItems: "center", gap: "12px", margin: 0 }}>
              <DoorOpen className="w-6 h-6" /> Portaria Virtual — Tutorial
            </h1>
            <p style={{ fontSize: "13px", color: isDark ? "rgba(255,255,255,0.7)" : "#475569", margin: 0, marginTop: "2px" }}>
      ...
      <main style={{ flex: 1, overflowY: "auto", padding: "16px 24px 120px" }}>
        <div style={{ display: "flex", flexDirection: "column", gap: "12px", marginTop: "8px" }}>
          ...
          <div style={{
            ...
            <p style={{ fontSize: "15px", color: isDark ? "rgba(255,255,255,0.8)" : "#334155", marginTop: "8px", lineHeight: 1.6 }}>
