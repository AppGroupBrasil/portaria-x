          ...
          <div style={{ marginLeft: "auto" }}>
            <TutorialButton title="Cadastro de Síndicos">
              ...
              <TSection icon={<span>🏗️</span>} title="COMO CADASTRAR">
                ...
                <p style={{ marginTop: "8px", fontSize: "14px", color: "#2d3354" }}>👉 O síndico já pode acessar o sistema e começar a configurar o condomínio.</p>
              </TSection>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
          ...
          <div className="rounded-xl p-5">
            <div className="flex gap-3">
              <UserCog className="w-6 h-6 shrink-0 mt-0.5" style={{ color: isDark ? "#ffffff" : "#38bdf8" }} />
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div style={{ marginBottom: "19px" }}>
                  ...
                  {condominios.length > 0 ? (
                    ...
                    <p style={{ color: "#facc15", fontSize: "14px" }}>
                ...
                {/* Error Modal */}
                {error && (
                  <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(0,0,0,0.55)", display: "flex", alignItems: "center", justifyContent: "center", padding: "1rem" }} role="button" tabIndex={0} onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { (() => setError(""))(); } }} onClick={() => setError("")}>
