...
export default function CadastrarVisitante() {
  ...
  const statusIcon = (status: string) => {
    if (status === "liberado") return <CheckCircle2 className="w-6 h-6" style={{ color: "#16a34a" }} />;
    if (status === "recusado") return <XCircle className="w-6 h-6" style={{ color: "#dc2626" }} />;
    return <Clock className="w-6 h-6" style={{ color: "#9ca3af" }} />;
  };
    ...
    <div className="min-h-dvh flex flex-col" style={{ background: p.pageBg }}>
      ...
      <div className="action-grid-pedestres" style={{ padding: "12px 24px", display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: "10px" }}>
        ...
        >
          ...
          <span style={{ fontSize: "12px", fontWeight: 700, textAlign: "center", lineHeight: 1.3 }}>CADASTRAR VISITANTE</span>
        </button>
        <button
        ...
        >
          ...
          <span style={{ fontSize: "12px", fontWeight: 700, textAlign: "center", lineHeight: 1.3 }}>RECONHECIMENTO FACIAL</span>
        </button>
        <button
        ...
        >
          ...
          <span style={{ fontSize: "12px", fontWeight: 700, textAlign: "center", lineHeight: 1.3 }}>PRE-AUTORIZADOS</span>
          {preAuths.length > 0 && (
            <span style={{
        ...
        >
          ...
          <span style={{ fontSize: "12px", fontWeight: 700, textAlign: "center", lineHeight: 1.3 }}>QR CODE AUTO CADASTRO</span>
        </button>
      </div>

      {/* Camera Embed — toggle + live feed */}
      <div style={{ padding: "0 24px 8px" }}>
        <span style={{ display: "flex", alignItems: "center", gap: "12px", cursor: "pointer", fontSize: "14px", fontWeight: 500, color: "var(--muted-foreground)" }}>
          <input
            type="checkbox"
              ...
              {ALL_FIELDS.map((field) => {
                ...
                return (
                  ...
                  >
                    ...
                    {on ? (
                      <ToggleRight className="w-7 h-7" style={{ color: "#0ea5e9" }} />
                    ) : (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <ChevronDown className="w-5 h-5 text-muted-foreground absolute right-3 top-3 pointer-events-none" />
                </div>
              </div>
              )}
                ...
                >
                  ...
                  >
                    <span className="text-xs text-white font-bold flex items-center gap-1.5 tracking-wide">
                      {auth.tipo === "auto_cadastro" ? (
                        <><Link2 className="w-5 h-5" /> AUTO CADASTRO</>
                      ) : (
                        <><ShieldCheck className="w-5 h-5" /> AUTORIZAÇÃO PRÉVIA</>
                      )}
                    </span>
                    <div className="flex items-center gap-2">
                      {inSchedule && (
                  ...
                  <div style={{ padding: "14px 16px" }}>
                    <div className="flex items-start gap-3 mb-3">
                      ...
                      <div className="flex-1">
                        <h3 className="font-bold text-foreground" style={{ fontSize: "16px", lineHeight: 1.3 }}>{auth.visitante_nome}</h3>
            ...
            if (entry.tipo === "visitante") {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="text-xs text-white font-bold flex items-center gap-1.5 tracking-wide">
                      <UserPlus className="w-5 h-5" /> VISITANTE
                    </span>
                    <span className="text-[11px] text-white/80 font-medium">
                  ...
                  <div style={{ padding: "14px 16px" }}>
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="font-bold text-foreground truncate" style={{ fontSize: "16px" }}>{v.nome}</p>
                    ...
                    {gateEnabled && (
                      ...
                      >
                        {gateOpening ? (
                          ...
                          <>
                            <CheckCircle2 className="w-6 h-6" /> Portão Aberto!
                          </>
                        ) : (
                          <>
                            <DoorOpen className="w-6 h-6" /> Abrir Portão
                          </>
                        )}
                      </button>
                    )}
              ...
              <div className="w-full max-w-sm">
                <div className="rounded-2xl overflow-hidden" style={{ backgroundColor: "rgba(255,255,255,0.08)" }}>
                  ...
                  <div className="flex items-center gap-2 px-4 py-3" style={{ backgroundColor: "rgba(234,179,8,0.15)" }}>
                    <ScanFace className="w-6 h-6" style={{ color: "#eab308" }} />
