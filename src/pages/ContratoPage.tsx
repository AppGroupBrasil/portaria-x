...
import { ArrowLeft, Printer, Share2, FileText, Copy, MessageCircle, Check } from "lucide-react";
...
function SignatureBlock({ label, name, detail }: Readonly<{ label: string; name: string; detail: string }>) {
  return (
...
export default function ContratoPage() {
  ...
  const totalMensal = planObj?.price ?? 0;
  ...
  const handleShareWhatsApp = () => {
    const text = encodeURIComponent("Confira o modelo de contrato do Portaria X: " + globalThis.window.location.href);
    globalThis.open(`https://wa.me/${WHATSAPP_NUMBER}?text=${text}`, "_blank", "noopener,noreferrer");
  };
      ...
      <div className="contract-container" style={{
        ...
        <Section n="2" title="DO OBJETO">
          ...
          <ul style={{ paddingLeft: "24px" }}>
            <li>Cadastro de Visitantes com foto, documento e QR Code de acesso</li>
            <li>Autorizações Prévias de Visitantes</li>
            <li>Correspondências com Notificação Push e WhatsApp</li>
            <li>Gestão de Delivery com código de autorização</li>
            ...
            <li>QR Scanner para validação instantânea de visitantes</li>
            <li>Gestão de Condomínio (blocos, moradores, funcionários)</li>
        ...
        {/* Cláusula 4 */}
        <Section n="4" title="DO PERÍODO DE TESTE">
          <p>
            <strong>4.1.</strong> A CONTRATANTE terá direito a um período de teste gratuito de <strong>7 (sete) dias corridos</strong>,
            contados a partir da ativação do sistema.
          </p>
          <p>
            <strong>4.2.</strong> Ao término do período de teste, caso a CONTRATANTE não manifeste interesse
            na continuidade, o acesso será suspenso automaticamente, sem qualquer cobrança.
          </p>
        </Section>

        {/* Cláusula 5 */}
        <Section n="5" title="DA VIGÊNCIA">
          <p>
            <strong>5.1.</strong> O presente contrato terá vigência por prazo indeterminado, iniciando-se
            na data de sua assinatura.
          </p>
          <p>
            <strong>5.2.</strong> <strong>NÃO HÁ FIDELIDADE</strong>. Qualquer das partes poderá rescindir o presente
            contrato a qualquer tempo, mediante comunicação prévia de <strong>30 (trinta) dias</strong>.
          </p>
          <p>
            <strong>5.3.</strong> Não haverá multa por rescisão antecipada.
          </p>
        </Section>

        {/* Cláusula 6 */}
        <Section n="6" title="DAS OBRIGAÇÕES DA CONTRATADA">
        ...
        {/* Cláusula 7 */}
        <Section n="7" title="DAS OBRIGAÇÕES DA CONTRATANTE">
        ...
        {/* Cláusula 8 */}
        <Section n="8" title="DA PROTEÇÃO DE DADOS (LGPD)">
          <p>
            <strong>8.1.</strong> A CONTRATADA se compromete a tratar os dados pessoais coletados pelo sistema
            em conformidade com a Lei Geral de Proteção de Dados (Lei nº 13.709/2018), atuando como{" "}
            <strong>Operadora de Dados</strong>.
          </p>
          <p>
            <strong>8.2.</strong> Os dados pessoais de moradores, visitantes e funcionários cadastrados no
            sistema são de responsabilidade da CONTRATANTE (<strong>Controladora de Dados</strong>).
          </p>
          <p>
            <strong>8.3.</strong> Em caso de rescisão contratual, a CONTRATADA manterá os dados por até{" "}
            <strong>90 (noventa) dias</strong> para eventual migração, após os quais serão definitivamente excluídos.
          </p>
        </Section>

        {/* Cláusula 9 */}
        <Section n="9" title="DA PROPRIEDADE INTELECTUAL">
          <p>
            <strong>9.1.</strong> O sistema "Portaria X", incluindo código-fonte, design, documentação e
            marca, é de propriedade exclusiva da APP GROUP LTDA - ME.
          </p>
          <p>
            <strong>9.2.</strong> O presente contrato não transfere qualquer direito de propriedade intelectual
            à CONTRATANTE, que recebe apenas licença de uso não-exclusiva durante a vigência contratual.
          </p>
        </Section>

        {/* Cláusula 10 */}
        <Section n="10" title="DO REAJUSTE">
          <p>
            <strong>10.1.</strong> Os valores poderão ser reajustados anualmente com base no índice IGPM/FGV
            ou, na sua ausência, pelo IPCA/IBGE.
          </p>
          <p>
            <strong>10.2.</strong> Qualquer reajuste será comunicado com antecedência mínima de <strong>30 (trinta) dias</strong>.
          </p>
        </Section>

        {/* Cláusula 11 */}
        <Section n="11" title="DA RESCISÃO">
          <p>
            <strong>11.1.</strong> O presente contrato poderá ser rescindido:
          </p>
          <ul style={{ paddingLeft: "24px", marginTop: "8px" }}>
...
function Section({ n, title, children }: Readonly<{ n: string; title: string; children: React.ReactNode }>) {
  return (
